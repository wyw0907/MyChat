...
#define GPIO_NRF24L01_CE  GPIOA
#define RCC_NRF24L01_CE  RCC_APB2Periph_GPIOA
...
#define NRF24L01_IRQ      GPIO_Pin_3
...
u8 NRF24L01_Write_Buf(u8 regaddr, const u8 *pBuf, u8 datalen); //写数据区
...
void NRF24L01_ComSet(void);
u8 NRF_SendPacket(u8 *pData);
